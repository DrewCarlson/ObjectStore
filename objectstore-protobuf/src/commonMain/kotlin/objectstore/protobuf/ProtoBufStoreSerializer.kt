...
private val defaultProtoBuf = ProtoBuf {
    encodeDefaults = true
}

@OptIn(ExperimentalSerializationApi::class)
public class ProtoBufStoreSerializer(
    ...
    override fun <T : Any> deserialize(type: KType, data: String): T {
        return protoBuf.decodeFromHexString(serializer(type), data) as T
    }

    override fun <T : Any> serialize(type: KType, data: T): String {
        return protoBuf.encodeToHexString(serializer(type), data)
    }
}
